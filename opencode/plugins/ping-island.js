...
const BRIDGE_ARGS = ["\/Users\/jason\/.ping-island\/bin\/ping-island-bridge","--source","claude","--client-kind","opencode","--client-name","OpenCode","--client-origin","cli","--client-originator","OpenCode","--thread-source","opencode-plugin"];
const ENV_KEYS = [
  "TERM_PROGRAM",
  "ITERM_SESSION_ID",
  "TERM_SESSION_ID",
