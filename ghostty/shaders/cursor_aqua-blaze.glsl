...
const vec4 TRAIL_COLOR = vec4(0.110, 0.380, 0.482, 1.0); // #1c617b
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
const vec4 TRAIL_COLOR_ACCENT = vec4(0.137, 0.663, 0.835, 1.0); // #23a9d5
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    newColor = mix(newColor, TRAIL_COLOR, antialising(sdfTrail) * 1.3 );
